...
def run():
	...
	runPath=os.path.join(dirPath,'record_subscription.py')
...
def results():
	...
	if os.path.exists(dirPath):
		staticInputs=json.load(open(os.path.join(dirPath,'static_inputs.json')))
		fpath=os.path.join(dirPath,staticInputs['csv_filename'])
